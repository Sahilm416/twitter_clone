 ...
 const LikeComment = async (count, id, isLiked) => {
  ...
  return (
    <div className=" flex  justify-between items-center">
      ...
      {modal && (
        <div
          className="w-[100vw] h-[100vh] fixed top-[0px] right-0 bg-[rgba(1,1,1,0.30)] z-40 flex justify-center gap-0 px-2  items-center"
        ...
        >
          ...
          <div className=" w-[400px] flex justify-end items-center">
            ...
            <button onClick={()=> setModal(false)} className=" rounded-full hover:bg-slate-800 bg-transparent p-0 m-1">
          ...
          <div className="  cursor-pointer flex gap-3   h-auto w-[400px] px-2 pb-2 z-50 ">
            ...
            <div className=" w-full flex flex-col gap-3">
              ...
              <div className=" w-[300px] flex justify-end items-center">
                     <button onClick={replyTweet} className=" p-2 rounded-2xl w-[100px] bg-blue-500 text-white hover:bg-blue-700">Reply</button>
              </div>
            </div>
          </div>
          </div>
